...
exports.initMCPHandler = initMCPHandler;
...
// ==================== TOOL HANDLERS ====================
function buildSSHCommand(tool, args) {
...
// ==================== MESSAGE HANDLER ====================
async function handleMCPCommand(message, client) {
    ...
    try {
        ...
        await sendMCPResponse(message.channel, {
            status: 'error',
...
async function sendMCPResponse(channel, response) {
...
exports.default = { handleMCPCommand, initMCPHandler };
