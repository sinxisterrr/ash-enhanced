...
exports.DiscordVoiceSender = void 0;
...
class DiscordVoiceSender {
    ...
    async sendVoiceMessage(options) {
        ...
        try {
            ...
            const attachment = new discord_js_1.AttachmentBuilder(ttsResult.audioBuffer, {
                name: 'voice_message.mp3',
                description: `Voice message: ${sanitizedText.substring(0, 100)}${sanitizedText.length > 100 ? '...' : ''}`
            });
            // Send to Discord
            let sentMessage;
            if (options.target instanceof discord_js_1.Message) {
                // Reply to a message
                if (options.replyToMessageId) {
                    ...
                    sentMessage = await options.target.channel.send({
                        files: [attachment]
                    });
                }
            }
...
exports.DiscordVoiceSender = DiscordVoiceSender;
