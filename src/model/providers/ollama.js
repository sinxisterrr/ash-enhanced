...
exports.ollamaCompletion = ollamaCompletion;
const logger_js_1 = require("../../utils/logger.js");
async function ollamaCompletion(model, messages) {
    try {
        ...
        if (!res.ok) {
            ...
            logger_js_1.logger.error("Ollama error:", res.status, text);
        ...
        logger_js_1.logger.error("Ollama connection failed:", err);
