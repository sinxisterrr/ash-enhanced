...
const VitalsLogger_js_1 = require("./body/monitor/VitalsLogger.js");
...
async function initAshSystems() {
    ...
    vitalsLogger = new VitalsLogger_js_1.VitalsLogger(exports.bodySystem, 60000);
